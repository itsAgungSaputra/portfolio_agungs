...
const Contact = ({ isDarkMode }) => {
  return (
    <div className={`px-6 max-w-[1200px] mx-auto py-20`} id="contact">
      <Reveal>
        <div className="grid md:grid-cols-[1fr_2fr] gap-12">
          ...
          <div className={`space-y-8 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <div className={`flex items-center gap-6 p-6 rounded-xl transition-all ${
              ...
              <div className={`p-3 rounded-lg ${isDarkMode ? 'bg-primary-color/10' : 'bg-primary-color/20'}`}>
                <AiFillPhone className="text-3xl text-primary-color" />
              </div>
              <div>
            ...
            <div className={`flex items-center gap-6 p-6 rounded-xl transition-all ${
              ...
              <div className={`p-3 rounded-lg ${isDarkMode ? 'bg-primary-color/10' : 'bg-primary-color/20'}`}>
                <AiOutlineMail className="text-3xl text-primary-color" />
              </div>
              <div>
            ...
            <div className={`flex items-center gap-6 p-6 rounded-xl transition-all ${
              ...
              <div className={`p-3 rounded-lg ${isDarkMode ? 'bg-primary-color/10' : 'bg-primary-color/20'}`}>
                <AiFillEnvironment className="text-3xl text-primary-color" />
              </div>
              <div>
